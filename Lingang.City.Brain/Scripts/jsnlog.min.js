...
return g}__extends(b,d);b.prototype.setOptions=function(a){c("url",a,this);c("beforeSend",a,this);d.prototype.setOptions.call(this,a);return this};b.prototype.sendLogItemsAjax=function(b,d){try{if(f(this)){var g=this.xhr.readyState;0!=g&&4!=g&&this.xhr.abort();g="LingangCityBrain/jsnlog.logger";null!=a.defaultAjaxUrl&&(g=a.defaultAjaxUrl);this.url&&(g=this.url);this.xhr.open("POST",g);this.xhr.setRequestHeader("Content-Type","application/json");this.xhr.setRequestHeader("JSNLog-RequestId",a.requestId);var c=this;
