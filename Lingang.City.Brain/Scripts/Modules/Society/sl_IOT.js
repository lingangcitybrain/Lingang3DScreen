    ...
    return {
        ...
        loadSocietyIOT: function () {
            s_EchartAjax.getSocietyCgq(function (result) {
                ...
                $("#society-iot>.iot-li").eq(0).find("span").eq(1).html(data[6].lossSensorCount);
                ...
                $("#society-iot>.iot-li").eq(1).find("span").eq(1).html(data[4].lossSensorCount);
                ...
                $("#society-iot>.iot-li").eq(2).find("span").eq(1).html(data[3].lossSensorCount);
            });
        },
