define(["config", "common", "util"], function (con, com, util) {
    return {
        ...
        daytime: function () {
            ...
            //开启白天雾
            wm.getEnvironment(0).setFog(1, Q3D.colourValue(0.407843, 0.615686, 0.890196, 1).get(), 4500, 15000);
        ...
        nighttime: function () {
            ...
            wm.getEnvironment(0).setFog(1, Q3D.colourValue(0, 0.00784314, 0.05490196, 1).get(), 5000, 10000);
        ...
        dituSet:function(flag)
        {
            ...
            if (terrainmgr) {
                if (flag == 1) {
                    ...
                    terrainmgr.showTerrain("gaoqing_version_1");
                    ...
                    terrainmgr.hideTerrain("gaoqing_version_1");
