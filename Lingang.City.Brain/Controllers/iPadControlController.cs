...
namespace Lingang.City.Brain.Web.Controllers
{
    public class iPadControlController : Controller
    {
        ...
        /// <returns></returns>
        [HttpPost]
        public JsonResult defaultlayerview()
        {
        ...
        {            
            get
            {
                ...
                //大客流 - 人流热力图 
                dv.layer = "1";
                dv.xyz = "394895.5771472379,6035.9100341796875,-3417640.9438711153";
                dv.angle = "-59.699005126953125,0.4331291913986206,0.7310601472854614";
                ...
                //社区综治 - 摄像头
                dv.layer = "11";
                dv.xyz = "395609.77603123965,163.98956298828125,-3417072.6951220147";
                dv.angle = "-33.653995513916016,-6.481533527374268,-4.303944110870361";
                _layerViewList.Add(dv);
                dv = new defaultLayerView();
